...
for i in range(len(df_blog)):
    ...
    source_blog_index += blog.substitute(i = i, title=df_blog["Post Title"][i],image=photo_url,content=df_blog["Post Text"][i][:800]) + blog_foot 


source_blog_index    += "<br><br><br><br><br><br>" +foot

print(source_blog_index,    file=open(site_path + "blog-1.html",    'w'))
print(source_blog_index,    file=open(site_path + "index.html",    'w'))
