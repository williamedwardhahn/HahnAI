...
fig, ax = plt.subplots()
im = ax.imshow(X[100,0,:,:], cmap = 'gray')
ax.axis('off')
plt.savefig('static/plot1.svg',facecolor="#EEEEEC")
plt.close()
...
im = ax.imshow(x, cmap = 'gray')
ax.axis('off')
plt.savefig('static/plot2.svg',facecolor="#EEEEEC")
plt.close()
...
plt.plot(plot_train[0:epochs:10,])
plt.savefig('static/plot3.svg',facecolor="#EEEEEC")
plt.close()
 
plot_test  = np.zeros((epochs,))
plt.plot(plot_test[0:epochs:10,])
plt.savefig('static/plot4.svg',facecolor="#EEEEEC")
plt.close()
...
<header>
	...
	<aside>
	<a href="https://mpcrlab.com"><img src="{{url_for('static', filename='mpcrlogo.png')}}" alt="Tutorial logo"></a>
	</aside>
...
<main>
	...
	<figure>
	<img src="{{url_for('static', filename='plot1.svg')}}">
	<figcaption>MNIST Digit</figcaption>
	</figure>
	</article>
	...
	<header><h3>Figure</h3></header>
	<figure>
	<img src="{{url_for('static', filename='plot2.svg')}}">
	<figcaption>MNIST Digits</figcaption>
	</figure>
	</article>
	...
	<header><h3>Figure</h3></header>
	<figure>
	<img src="{{url_for('static', filename='plot3.svg')}}">
	...
	<header><h3>Figure</h3></header>
	<figure>
	<img src="{{url_for('static', filename='plot4.svg')}}">
	<figcaption>Testing Accuracy</figcaption>
	</figure>
	</article>
